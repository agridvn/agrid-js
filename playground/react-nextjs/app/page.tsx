...
import { AgridCaptureOnViewed } from '@agrid/react'
    ...
    return (
        <main style={{ minHeight: '100vh', padding: '2rem', backgroundColor: '#f5f5f5' }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                >
                    Cat Gallery - Agrid React Demo
                </h1>
                <p style={{ fontSize: '1.125rem', marginBottom: '2rem', color: '#666' }}>
                    Scroll down to see the cat gallery. When it comes into view, Agrid will track the event and
