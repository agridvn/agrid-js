...
describe('agrid-surveys', () => {
    describe('AgridSurveys Class', () => {
        let mockAgrid: Agrid & {
        ...
        describe('canRenderSurvey', () => {
            ...
            it('should return visible: true if surveys are loaded and the survey is eligible', () => {
                mockAgrid.get_property.mockReturnValue([survey])
        ...
        describe('checkSurveyEligibility', () => {
            ...
            it('cannot render completed surveys', () => {
                ...
                mockAgrid.get_property.mockReturnValue([completedSurvey])
            ...
            describe('check order and interaction between multiple eligibility criteria', () => {
                ...
                beforeEach(() => {
                    mockAgrid.get_property.mockReturnValue([surveyWithBothConditions])
                ...
                it('allows surveys that pass all checks including repeatability', () => {
                    ...
                    mockAgrid.get_property.mockReturnValue([repeatableSurveyWithWaitPeriod])
        ...
        describe('loadIfEnabled', () => {
            ...
            it('should not initialize if surveys are disabled', () => {
                mockAgrid.config.disable_surveys = true
                surveys.loadIfEnabled()
            ...
            it('should call the callback with the surveys when they are loaded', () => {
                ...
                mockAgrid.get_property.mockReturnValue(mockSurveys)
            ...
            it('should not load surveys in cookieless mode without consent', () => {
                mockAgrid.config.cookieless_mode = 'on_reject'
                const mockIsOptedOut = mockAgrid.consent.isOptedOut as jest.Mock
        ...
        describe('getSurveys', () => {
            ...
            it('should return cached surveys and not fetch if they exist', () => {
                ...
                expect(mockAgrid._send_request).not.toHaveBeenCalled()
            ...
            it('should reset _isFetchingSurveys after successful API call', () => {
                mockAgrid._send_request.mockImplementation(({ callback }) => {
                ...
                expect(mockAgrid.persistence?.register).toHaveBeenCalledWith({ [SURVEYS]: mockSurveys })
            })
            ...
            it('should reset _isFetchingSurveys when API call throws error', () => {
                mockAgrid._send_request.mockImplementation(() => {
            ...
            it('should handle delayed successful responses correctly', () => {
                ...
                expect(mockAgrid.persistence?.register).toHaveBeenCalledWith({ [SURVEYS]: delayedSurveys })
            })

            it('should set correct timeout value in request', () => {
                surveys.getSurveys(mockCallback)

                expect(mockAgrid._send_request).toHaveBeenCalledWith(
            ...
            it('should force reload surveys when forceReload is true', () => {
                ...
                expect(mockAgrid._send_request).toHaveBeenCalled()
            })
        })
    })
})
