...
A development playground for testing CSP violation reports with Agrid.
...
```bash
AGRID_TOKEN=your_agrid_token
AGRID_API_HOST=your_agrid_api_host  # e.g., https://app.agrid.com
AGRID_UI_HOST=your_agrid_ui_host    # e.g., https://app.agrid.com
AGRID_USE_SNIPPET=true                # if you want to include the agrid snippet on the playground pages to track pageviews, etc.
```
...
These test cases are specifically designed to debug report-to directive issues and test the logging functionality added in [PR #32868](https://github.com/Agrid/agrid/pull/32868):
...
This playground is useful for testing how CSP violation reports are processed by your Agrid instance. 