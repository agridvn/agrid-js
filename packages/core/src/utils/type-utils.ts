...
export const isFunction = (x: unknown): x is (...args: any[]) => any => {
  // eslint-disable-next-line agrid-js/no-direct-function-check
...
export const isObject = (x: unknown): x is Record<string, any> => {
  // eslint-disable-next-line agrid-js/no-direct-object-check
...
export const isString = (x: unknown): x is string => {
  // eslint-disable-next-line agrid-js/no-direct-string-check
...
export const isNull = (x: unknown): x is null => {
  // eslint-disable-next-line agrid-js/no-direct-null-check
  return x === null
}
...
export const isNumber = (x: unknown): x is number => {
  // eslint-disable-next-line agrid-js/no-direct-number-check
  return toString.call(x) == '[object Number]'
}
export const isBoolean = (x: unknown): x is boolean => {
  // eslint-disable-next-line agrid-js/no-direct-boolean-check
  return toString.call(x) === '[object Boolean]'
}

export const isFormData = (x: unknown): x is FormData => {
  // eslint-disable-next-line agrid-js/no-direct-form-data-check
  return x instanceof FormData
}

export const isFile = (x: unknown): x is File => {
  // eslint-disable-next-line agrid-js/no-direct-file-check
