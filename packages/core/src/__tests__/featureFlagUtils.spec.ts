...
import { AgridFlagsResponse, FeatureFlagDetail } from '@/types'
...
describe('featureFlagUtils', () => {
  ...
  describe('getFlagDetailsFromFlagsAndPayloads', () => {
    it('should convert v1 flags and payloads to flag details', () => {
      const flagsResponse: AgridFlagsResponse = {
        featureFlags: {
          'flag-1': true,
          'flag-2': 'variant-1',
          'flag-3': false,
  ...
  describe('normalizeFlagsResponse', () => {
    it('should convert v4 response to v1 format', () => {
      const v4Response: AgridFlagsResponse = {
        flags: {
          'flag-1': {
            key: 'flag-1',
            enabled: true,
    ...
    it('should convert v1 response to v4 format', () => {
      const v1Response: Omit<AgridFlagsResponse, 'flags'> = {
        featureFlags: {
          'flag-1': true,
          'flag-2': 'variant-1',
          'flag-3': false,
