...
describe('Agrid Core', () => {
  ...
  describe('ai', () => {
    it('should capture feedback', async () => {
      ...
      agrid.captureTraceFeedback('trace-id', 'feedback')
    ...
    it('should convert numeric traceId in captureTraceFeedback', async () => {
      ...
      agrid.captureTraceFeedback(10, 'feedback')
    ...
    it('should capture a metric', async () => {
      ...
      agrid.captureTraceMetric('trace-id', 'metric-name', 'good')
    ...
    it('should convert numeric arguments in captureTraceMetric', async () => {
      ...
      agrid.captureTraceMetric(10, 'metric-name', 1)
